...
INSERT INTO public.posts (author_id, category, title, content, location_text, crowd, location) VALUES
  ('19e552a2-673e-46ea-a488-6065c6be22ae', 'stock', '朝採れ野菜入荷しました！', 'トマト、きゅうり、なす 🍅 本日限り特別価格です', '越谷市駅前', 'crowded',
  ...
  ('7b3b3eed-00b6-43c2-be81-58481caab9b0', 'stock', '本日の焼きたてパン', 'クロワッサン、食パン、あんぱん揃ってます 🥐', '商店街エリア', 'moderate',
  ...
  ('8a4be860-1b25-477b-8f40-2e562f8f3720', 'admin', '【重要】給付金申請の締め切りは今月末です', 'お早めにお手続きください 📋', '市役所', NULL,
    ST_SetSRID(ST_MakePoint(139.7950, 35.8870), 4326)::geography),
  ('19e552a2-673e-46ea-a488-6065c6be22ae', 'stock', '産みたて卵入荷', '平飼い鶏の新鮮卵、1パック300円です 🥚', '越谷市駅前', 'empty',
  ...
  ('7b3b3eed-00b6-43c2-be81-58481caab9b0', 'stock', '春の花苗セール中', 'パンジー・チューリップ・ビオラ揃ってます 🌸', '商店街エリア', NULL,
    ST_SetSRID(ST_MakePoint(139.7885, 35.8825), 4326)::geography),
  ('8a4be860-1b25-477b-8f40-2e562f8f3720', 'admin', 'マイナンバー申請会のお知らせ', '予約不要です。お気軽にどうぞ', '市役所', NULL,
